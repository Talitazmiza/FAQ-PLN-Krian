         ...
         <nav id="main-menu" class="visible-lg-block navbar navbar-default pln">
            ...
            <div class="container">
               <div class="col-xs-10">
                ...
                <div class="col-xs-2">
                  <a href="http://www.pln.co.id"><img src="img/logo-header.jpg" alt="PT PLN (Persero)" title="PT PLN (Persero)"></a>
               </div>
        ...
        <nav id="m-main-menu" class="visible-xs-block visible-md-block visible-sm-block navbar navbar-default" role="navigation">
            <div class="container-fluid">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand pull-right" href="http://www.pln.co.id"><img src="img/logo-header.jpg" alt="PT PLN (Persero)" title="PT PLN (Persero)"></a>
               </div>
